...
public class NotifyActivity extends AppCompatActivity {
    ...
    private void deleteMode() {
        ...
        binding.nomalModeWindow.setVisibility(View.INVISIBLE);
        binding.deleteModeWindow.setVisibility(View.VISIBLE); // 화면을 deleteMode로 전환시킨다.
                            ...
                            (dialog, id) -> {
                                ...
                                if (!NetworkManager.networkCheck(getApplicationContext())) {
                                    ...
                                    if (dArrayList.isEmpty()) {
                                        ...
                                        binding.deleteModeWindow.setVisibility(View.INVISIBLE); // deleteMode시 보이는 요소들을 안보이게 한다.
                                        binding.nomalModeWindow.setVisibility(View.VISIBLE); // 일반모드로 전환시킨다.
                                        binding.allCheck.setChecked(false);
                                        deleteModeOn = false;
                                        init();
                                    }
